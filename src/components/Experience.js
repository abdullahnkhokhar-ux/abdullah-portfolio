...
function Experience() {
  const experiences = [
    ...
    },
    {
      ...
      description: "Founded, built and manage a next.js-based e-commerce platform specializing in premium herbal products. Handle everything from product sourcing, branding, digital marketing, to customer service and business operations.",
